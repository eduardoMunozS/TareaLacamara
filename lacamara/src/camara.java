...
public class camara extends javax.swing.JFrame {
    ...
    CascadeClassifier Objetodetectar;  // Objeto reconocedor de imagenes
  //  CascadeClassifier eyeDetector;   // Objeto para reconocer ojos

    MatOfRect detectarObjeto;   // Matriz donde se alojarán las caras detectadas
   // MatOfRect eyeDetections;   // Matriz donde se alojarán los ojos detectadas
    ...
    String faceFile = "zombidefinitive.xml";  // Archivo referencia para reconocimiento de rostros
  //  String eyeFile = "haarcascade_eye.xml";  // Archivo referencia para reconocimiento de rostros
    ...
    class DaemonThread implements Runnable {
        ...
        public void run() {
            ...
            Objetodetectar = new CascadeClassifier(base_path + faceFile); // Se crea un objeto CascadeClassifier que reconocera caras
            detectarObjeto = new MatOfRect(); // Se inicializa el objeto donde se guardaran las caras detectadas
                ...
                while (runnable) {
                    if (webSource.grab()) {
                        try {
                            ...
                            Objetodetectar.detectMultiScale(frame, detectarObjeto); // Se buscan las caras dentro de la imagen y se guardan en faceDetections
                            
                            int i= 0;
                            
                            for (Rect rect : detectarObjeto.toArray()) {
                                
                                // Se crea un cuadrito verde por cada cara detectada
                                Imgproc.rectangle(frame, new Point(rect.x, rect.y), new Point(rect.x + rect.width, rect.y + rect.height),
                                        new Scalar(244, 255, 201));

                               
                                juguete = frame.submat(detectarObjeto.toArray()[i]);
    ...
    private void initComponents() {
        ...
        setTitle("Captura de objeto-juguete");
        setCursor(new java.awt.Cursor(java.awt.Cursor.CROSSHAIR_CURSOR));
        setFont(new java.awt.Font("OCR A Extended", 2, 12)); // NOI18N
        ...
        jComboBox1.setBackground(new java.awt.Color(51, 255, 153));
